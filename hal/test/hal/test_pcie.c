...
#define TEST_PCIE_DMA_BUS_ADDR   0x3C000000 /**< refer to the brief of hal_pcie_dma.h struct DMA_TABLE param @bus */
#define TEST_PCIE_DMA_LOCAL_ADDR 0x3C000000 /**< refer to the brief of hal_pcie_dma.h struct DMA_TABLE param @local */
#define TEST_PCIE_DMA_SIZE       0x1000 /**< refer to the brief of hal_pcie_dma.h struct DMA_TABLE param @bufSize */
#define TEST_PCIE_DMA_CHAN       0 /**< refer to the brief of hal_pcie_dma.h struct DMA_TABLE param @chn */
...
TEST(HAL_PCIE, PCIeCPUSimpleTest){
    ...
    HAL_PCI_ReadConfigByte(cfg, 0x10, &val);
    printf(" - cfg read: Bar0=%lx\n", val);
    HAL_PCI_ReadConfigByte(cfg, 0x14, &val);
    printf(" - cfg read: Bar1=%lx\n", val);
    HAL_PCI_ReadConfigByte(cfg, 0x18, &val);
    printf(" - cfg read: Bar2=%lx\n", val);
    HAL_PCI_ReadConfigByte(cfg, 0x1C, &val);
    printf(" - cfg read: Bar3=%lx\n", val);
    HAL_PCI_ReadConfigByte(cfg, 0x20, &val);
    printf(" - cfg read: Bar4=%lx\n", val);
    HAL_PCI_ReadConfigByte(cfg, 0x24, &val);
    printf(" - cfg read: Bar5=%lx\n", val);
